...
* **Behavior:** Das ist die lebendige Hülle um die Daten. Es muss **immutable** (unveränderlich) sein, um seine Integrität zu gewährleisten und Race Conditions zu vermeiden.
...
#### **4.1.3. Handlungen (Capabilities/Actions)**
...
### **4.3 Anwendung mit UI of Objects (in Swing)**

Um die Theorie in die Praxis umzusetzen, betrachten wir ein Swing-Beispiel. Anstatt ein JFrame zu bauen, das Daten aus einem User-Objekt zieht (user.getName()), drehen wir den Spieß um. Wir geben dem Objekt eine „Leinwand“ (Interface als eine digitale Arbeitsfläche), auf die es sich selbst malt. Das Objekt LoginSession ist der Chef. Es bestimmt, wie der Login aussieht und was passiert, wenn geklickt wird. Die Swing-Klassen sind nur dumme Werkzeuge.
...
// 2\. Ein simpler Buffer für den Datentransfer (anstatt Getter/Setter)    
...
* **Kein Get/Anemic Model:** Die LoginSession exponiert keine Getter. Das Domänenobjekt wird nicht 'ausgefragt'; sein interner Zustand (E-Mail/Passwort) bleibt gekapselt.  
...
### **4.4 Anwendung mit UI of Objects (in React)**
...
* Alen Key: Definition of Object-Oriented-Programming (2003) https://www.quora.com/What-does-Alan-Kay-mean-when-he-said-OOP-to-me-means-only-messaging-local-retention-and-protection-and-hiding-of-state-process-and-extreme-late-binding-of-all-things-It-can-be-done-in-Smalltalk-and-in-LISP  
* Max Stepanov: Object-Oriented UX and Object-Oriented UI (2024)  
* Robert Bräutigam: Single Responsibility Principle (2018)   
  https://speakerdeck.com/robertbraeutigam/single-responsibility-principle  
* Robert Bräutigam: Object-Oriented Domain-Driven Design (2018)  
