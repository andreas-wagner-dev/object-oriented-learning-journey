...
Root Package \= Core Domön, unabhängig von allem.
...
\- z. B. application/SpingShop oder main/ShopMain
...
* user/ human/(GUI interfaces or REST interfaces for GUI e.g. React)  
...
Isolieren Sie alle technischen in ein dediziertes Paket z. B. exchange/ gefolgt von weiteren Unterpaketen wie: 
...
* Nur die Domain-Adapter/Decorator (wie DbPayments) greifen auf \`storage/\` zu
