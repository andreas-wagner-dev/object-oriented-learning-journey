...
├── index.md                           # I[1] (System overview & core goals)  
└── customer/                          # D[1] (Main Domain: Customer Context)  
    ├── index.md                       # I[1.1] (Context map for Customer Domain)  
    ├── profile.md                     # C[1.2] (Core concept: Customer Profile data)  
    └── billing/                       # D[1.3] (Sub-domain: Billing details)  
        ├── index.md                   # I[1.3.1] (Billing context map)  
        ├── payment_methods.md         # C[1.3.2] (Sub-concept: Accepted payment configurations)  
        └── invoices/                  # D[1.3.3] (Sub-sub-domain: Invoice processing)  
            ├── index.md               # I[1.3.3.1] (Invoice context map)  
            └── tax_calculation.md     # C[1.3.3.2] (Atomic logic: Tax calculation rules)
```
