...
Ziel ist es, SRP auf eine **pragmatische und objektive Weise** zu definieren, damit es direkt in unsere tägliche Programmplanung integriert werden kann. Nicht als abstraktes Designideal, das im Code-Review subjektiv interpretiert wird, sondern als messbare Eigenschaft, die Werkzeuge automatisch prüfen und Entwickler gezielt anstreben können.
